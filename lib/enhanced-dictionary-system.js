...
console.log('🔍 Enhanced Dictionary raw data:', {
  wordCount: words?.length || 0,
  sampleWord: words?.[0] ? {
    italian: words[0].italian,
    rawTranslationsCount: words[0].word_translations?.length || 0,
    rawTranslations: words[0].word_translations
  } : null
});
