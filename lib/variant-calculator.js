  ...
  static calculateGenderVariants(storedForm, wordTags) {
    ...
    if (isPlural) {
      ...
      variants.push({
        ...
        resolved_translation_groups: storedForm.resolved_translation_groups
          ? storedForm.resolved_translation_groups
              .map(ft => ({ ...ft }))
              .sort((a, b) => (String(a.translation || '').startsWith('you ') ? -1 : 1))
          : [],
