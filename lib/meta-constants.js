...
export const ATTRIBUTES = {
  ...
  NUMBER: "b83d846f-ec8e-4f01-842b-e1afe1cda090", // metaattr012
  ...
  EXPRESSION_TYPE: "4dae22ed-494f-4274-998e-4beadbd6b5d9", // metaattr069
}
...
export const VALUES = {
  ...
  NUMBER_RESTRICTION_SINGULAR_ONLY: "2792e966-b266-4d2d-9385-485ad967e056", // metaattr013val055
  NUMBER_RESTRICTION_PLURAL_ONLY: "0a9d7ba7-3726-4b3d-a482-9e99bf5c055b", // metaattr013val056
  ...
  EXPRESSION_TYPE_SINGLE_WORD: "9f19a073-8c9d-49ec-8dc9-a9f55d22a90b", // metaattr069val001
  EXPRESSION_TYPE_MULTIWORD_EXPRESSION: "8c3f5b9e-d18d-4b6c-ac54-4fb94354d8b5", // metaattr069val002
  ...
  // Verb Form Type values
  VERB_FORM_TYPE_SIMPLE: "9f66ed98-41ee-4fdd-bf46-61031a2a84d8", // metaattr022val107
  VERB_FORM_TYPE_COMPOUND: "9e56f638-b692-406e-b65b-11d447f84bcf", // metaattr022val106
  VERB_FORM_TYPE_PROGRESSIVE: "4979ad40-12ef-4bf7-ae60-9e6a080f3a38", // metaattr022val105

}

// Stable ID to UUID mapping for backward compatibility
export const STABLE_ID_TO_UUID = {
  'metaattr001': "21e95d9a-9523-400f-91ab-5f877df71d84", // ADVERB_TYPE
  'metaattr002': "65289998-b2c4-4dfd-8212-1f7cb9635dc4", // AUXILIARY_VERB
  'metaattr003': "554a6624-fd30-4d1c-b664-5f8433dfe576", // CEFR_LEVEL
  'metaattr004': "74df568f-0ed3-4f74-9979-f6d64fc7a54b", // CONJUGATION_TYPE
  'metaattr005': "4dc48097-de1d-4dc8-9371-ab8a5d320203", // IRREGULAR_FORMS
  'metaattr006': "36e6b866-c2cf-48b5-ba67-2fa70a1522b5", // FORM_PATTERN
  'metaattr007': "3c909352-4588-4951-8076-6f23081d99be", // FREQUENCY_TIER
  'metaattr008': "7b1a301d-4f4c-405f-b6d7-01af1efb8574", // GENDER_USAGE
  'metaattr009': "f40a8c4c-09cf-4385-a612-dbf90d3bd478", // GRADABLE
  'metaattr010': "379ac74b-7851-4d17-a01e-fb6881062688", // MOOD
  'metaattr011': "08a37467-3de5-42b2-a22a-29127c58c942", // WORD_GENDER
  'metaattr012': "b83d846f-ec8e-4f01-842b-e1afe1cda090", // NUMBER
  'metaattr013': "6aa64a52-2009-4d0c-ad77-a6c57b69ebce", // NUMBER_RESTRICTION
  'metaattr014': "f284ff99-816e-4dfd-a18d-e52612458bb4", // PERSON
  'metaattr017': "ac7dbcf5-28bb-4432-9210-f6a0a90098e4", // REFLEXIVE
  'metaattr018': "f3e4381a-e48b-4317-b581-56634fa63879", // REGISTER
  'metaattr019': "4478177c-a43a-49aa-926c-278bc546e035", // TENSE
  'metaattr020': "1647e6f1-9387-47b7-be5d-3cd0df1dde4c", // TRANSITIVITY
  'metaattr021': "88358c12-5112-45f9-b0a0-a6239c41a064", // REFLEXIVE_TYPE
  'metaattr022': "5772c0c9-40c3-46b7-85ac-27442184a794", // VERB_FORM_TYPE
  'metaattr026': "17c23a79-4828-439b-8560-1741b165bc07", // PLURAL_FORMATION
  'metaattr069': "4dae22ed-494f-4274-998e-4beadbd6b5d9", // EXPRESSION_TYPE
  // Position might be a non-metaattr, handle dynamically
  'position': "7e9e8be7-8cf0-4560-baeb-82105be43873", // POSITION
}

// Helper functions for UUID-based lookups
export const isAttribute = (tagObject, attributeUuid) => {
  // Handle UUID-based matching (new RPC system)
  if (tagObject.attribute_id === attributeUuid) {
    return true
  }
  
  // Handle stable_id-based matching (backward compatibility)
  if (tagObject.attribute_stable_id) {
    const mappedUuid = STABLE_ID_TO_UUID[tagObject.attribute_stable_id]
    return mappedUuid === attributeUuid
  }
...
export const TAG_DISPLAYS = {
  ...
  // Expression Type
  [VALUES.EXPRESSION_TYPE_SINGLE_WORD]: { display: 'single word', class: 'bg-gray-100 text-gray-700', essential: false },
  [VALUES.EXPRESSION_TYPE_MULTIWORD_EXPRESSION]: { display: 'multiword', class: 'bg-indigo-100 text-indigo-700', essential: false },
  ...
  [VALUES.TRANSITIVITY_TRANSITIVE]: { display: '🎯 trans', class: 'bg-green-100 text-green-700', essential: false, description: 'Transitivity - Transitive: Takes direct objects' },
  [VALUES.TRANSITIVITY_INTRANSITIVE]: { display: '🌀 intrans', class: 'bg-blue-100 text-blue-700', essential: false, description: 'Transitivity - Intransitive: Does not take direct objects' },
  [VALUES.TRANSITIVITY_AMBITRANSITIVE]: { display: '⚖️ ambi', class: 'bg-purple-100 text-purple-700', essential: false, description: 'Transitivity - Ambitransitive: Can be transitive or intransitive' },

  // Reflexive Type (translation-level detailed tags)
  [VALUES.REFLEXIVE_TYPE_DIRECT]: { display: '🔄 direct', class: 'bg-blue-100 text-blue-700', essential: false, description: 'Reflexive Type - Direct: Action on oneself (mi lavo)' },
  [VALUES.REFLEXIVE_TYPE_RECIPROCAL]: { display: '🫂 reciprocal', class: 'bg-purple-100 text-purple-700', essential: false, description: 'Reflexive Type - Reciprocal: Mutual action (ci laviamo)' },

  // Verb Form Type (form-level construction tags)
  [VALUES.VERB_FORM_TYPE_SIMPLE]: { display: '🔹 simple', class: 'bg-green-100 text-green-700', essential: false, description: 'Verb Form Type - Simple: Single-word forms (parlo, parlavo)' },
  [VALUES.VERB_FORM_TYPE_COMPOUND]: { display: '🔗 compound', class: 'bg-orange-100 text-orange-700', essential: false, description: 'Verb Form Type - Compound: Auxiliary + participle (ho parlato)' },
  [VALUES.VERB_FORM_TYPE_PROGRESSIVE]: { display: '⏳ progressive', class: 'bg-blue-100 text-blue-700', essential: false, description: 'Verb Form Type - Progressive: Stare + gerund (sto parlando)' },
}
